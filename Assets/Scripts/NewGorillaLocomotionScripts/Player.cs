namespace GorillaLocomotion
{
    ...
    public class Player : MonoBehaviour
    {
        ...
        [SerializeField] private InputAction toggleMovementAction;
        ...
        private void Update()
        {
            if (toggleMovementAction.WasPerformedThisFrame())
            {
                Debug.Log("Toggling GorillaLocomotion!");
